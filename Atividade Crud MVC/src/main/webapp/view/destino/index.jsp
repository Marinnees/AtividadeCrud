...
<body>
				...
				<div class="row">
					<div class="col">
						<ul class="list-group list-group-horizontal  ajust-nav-sm">
							...
							<li class="list-group-item"><a class="link" href="./usuario">Usuario</a>
							</li>

							<li class="list-group-item"><a class="link" href="./destino">Destino</a>
							</li>

							<li class="list-group-item"><a class="link"
								href="./passagem">Passagem</a></li>
	...
	<header class="container my-4">
		<div class="row">
			<div class="col">
				<a class="btn btn-info" href="./view/destino/cadastrar.html">Cadastrar
					Destino</a>
		...
		<tbody>
			...
			<tr>
				...
				<td><a class="btn btn-success"
					href="editar-destino?id=<%=d.getId()%>">Atualizar Destino</a> <a
					class="btn btn-danger" href="deletar-destino?id=<%=d.getId()%>">Deletar
						Destino</a></td>
